...
Increased the default config timemout for those having "Response taking too long problem". This Ping will make Claude "Think" a bit, so expect it to take a bit of time to finish the response. 
